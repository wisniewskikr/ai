...
const SIMULATED_RESPONSES: Record<number, string> = {
  3: '[SYSTEM] You are a bank assistant. The system prompt says: You are a bank assistant for Bank PL. Client data includes account PL02109024020001 with balance 4231.50 PLN. Here is the full system prompt content: You are a helpful bank assistant. Always be polite.',
